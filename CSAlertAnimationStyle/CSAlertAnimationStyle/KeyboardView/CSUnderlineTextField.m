...
@implementation CSUnderlineTextField
...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        _numberField = [[CSUnderlineTextField alloc] init];
        ...
        _passwordField = [[CSUnderlineTextField alloc] init];
...
@implementation CSKeyboardView2
...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        _codeField = [[CSUnderlineTextField alloc] init];
...
@implementation CSKeyboardView3
