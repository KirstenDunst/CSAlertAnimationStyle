...
#define CSOverflyViewLineColor [UIColor colorWithHexString:@"bfbfbf"]

@interface CSOverflyButton ()

@property (nonatomic, strong) CALayer *horizontalLine;
@property (nonatomic, strong) CALayer *verticalLine;
@property (nonatomic, copy) void (^buttonClickedBlock)(CSOverflyButton *alertButton);

@end

@implementation CSOverflyButton

+ (instancetype)buttonWithTitle:(NSString *)title handler:(void (^)(CSOverflyButton * _Nonnull))handler {
    return [[self alloc] initWithTitle:title handler:handler];
}

- (instancetype)initWithTitle:(NSString *)title handler:(void (^)(CSOverflyButton * _Nonnull))handler {
    if (self = [super init]) {
        ...
        _horizontalLine.backgroundColor = CSOverflyViewLineColor.CGColor;
        [self.layer addSublayer:_horizontalLine];
        
        _verticalLine = [CALayer layer];
        _verticalLine.backgroundColor = CSOverflyViewLineColor.CGColor;
...
- (instancetype) initWithFlyImage:(UIImage *)flyImage
    ...
    if (self = [super init]) {
        ...
        _splitLine.backgroundColor = CSOverflyViewLineColor.CGColor;
...
- (void)addAction:(CSOverflyButton *)action {
    ...
    CSOverflyButton *lastAction = objc_getAssociatedObject(self, zhOverflyViewActionKey);
...
- (void)adjoinWithLeftAction:(CSOverflyButton *)leftAction rightAction:(CSOverflyButton *)rightAction {
...
- (void)clearActions:(NSArray<UIView *> *)subviews {
    for (UIView *subview in subviews) {
        if ([subview isKindOfClass:[CSOverflyButton class]]) {
